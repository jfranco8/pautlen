...
gcc -ggdb -Wall -pedantic -m32 -o ejem5 ejem5.o alfalib.o

./ejemplo6 ej6.asm
nasm -g -o ejem6.o -f elf32 ej6.asm
gcc -ggdb -Wall -pedantic -m32 -o ejem6 ejem6.o alfalib.o

./ejemplo7 ej7.asm
nasm -g -o ejem7.o -f elf32 ej7.asm
gcc -ggdb -Wall -pedantic -m32 -o ejem7 ejem7.o alfalib.o
